<%@ Page Title="" Language="C#" MasterPageFile="~/View/HeaderFooter.Master" AutoEventWireup="true" CodeBehind="InsertPaymentType.aspx.cs" Inherits="TokoBeDia.View.InsertPaymentType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-2 offset-5">
        ...
        <asp:Button ID="InsertPaymentTypeBtn" runat="server" CssClass="btn btn-lg btn-secondary btn-block" Text="Insert Payment Type" ValidationGroup="groupPaymentType" OnClick="InsertPaymentTypeBtn_Click" />
        <hr />
