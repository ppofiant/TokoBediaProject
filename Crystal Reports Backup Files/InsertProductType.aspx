<%@ Page Title="" Language="C#" MasterPageFile="~/View/HeaderFooter.Master" AutoEventWireup="true" CodeBehind="InsertProductType.aspx.cs" Inherits="TokoBeDia.View.InsertProductType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-2 offset-5">
        ...
        <asp:Button ID="InsertProductTypeBtn" runat="server" CssClass="btn btn-lg btn-secondary btn-block" Text="Insert Product Type" ValidationGroup="groupProductType" OnClick="InsertProductTypeBtn_Click" />
        <hr />
