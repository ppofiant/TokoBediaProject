...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <asp:Label ID="LblQty" runat="server" Text="Product Quantity"></asp:Label>
            <asp:TextBox ID="TxtQty" CssClass="form-control" runat="server" placeholder="Input Product Quantity"></asp:TextBox>
    ...
    <br />
    <div class ="container">
        <asp:Button class="container" ID="UpdateBtn" runat="server" CssClass="btn btn-lg btn-warning btn-block" Text="Update Cart" ValidationGroup="groupLogin" OnClick="UpdateBtn_Click" Font-Bold="True" />
